# Go OpenAI
[![Go Reference](https://pkg.go.dev/badge/github.com/hengdai/go-openai.svg)](https://pkg.go.dev/github.com/hengdai/go-openai)
[![Go Report Card](https://goreportcard.com/badge/github.com/hengdai/go-openai)](https://goreportcard.com/report/github.com/hengdai/go-openai)
[![codecov](https://codecov.io/gh/hengdai/go-openai/branch/master/graph/badge.svg?token=bCbIfHLIsW)](https://codecov.io/gh/hengdai/go-openai)
...
```
go get github.com/hengdai/go-openai
```
...
import (
	"context"
	"fmt"
	openai "github.com/hengdai/go-openai"
)
...
See also: https://pkg.go.dev/github.com/hengdai/go-openai#ClientConfig
</details>
...
**Related Issues:**  
[omitempty option of request struct will generate incorrect request when parameter is 0.](https://github.com/hengdai/go-openai/issues/9)
...
**Related Issues:**  
[Is it possible to join the implementation of GPT3 Tokenizer](https://github.com/hengdai/go-openai/issues/62)

## Contributing

By following [Contributing Guidelines](https://github.com/hengdai/go-openai/blob/master/CONTRIBUTING.md), we hope to ensure that your contributions are made smoothly and efficiently.

## Thank you

We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/hengdai/go-openai/graphs/contributors) and sponsors of this project:
